...
In model 1, both `workingday` and `holiday` does not show a significant linear relationship with `count`. But it is reasonable to include `weekday` when predicting `registered` and `casual`.
 ![weekday and casual](https://docs.google.com/uc?export=view&id=https://docs.google.com/uc?export=view&id=0B47woKFE0zXeTnZXci1tXzlEZ2M)




##### Explore Explanatory variable #####
![count and numerical variable](https://docs.google.com/uc?export=view&id=https://docs.google.com/uc?export=view&id=0B47woKFE0zXeTnZXci1tXzlEZ2M)
